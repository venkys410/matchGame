...
class App extends Component {
      ...
      <div className="game-over-container">
        <div className="game-over-card">
          <img
            ...
            className="trophy"
          />
          <p className="final-score">Your Score</p>
  ...
  onClickThumbnail = imageUrl => {
    ...
    const randomImageUrlIndex = Math.ceil(Math.random() * imagesList.length - 1)
    this.setState({activeImageUrl: imagesList[randomImageUrlIndex].imageUrl})
  }
          ...
          <div className="logo-score-container">
            ...
            <div className="score-time-container">
              ...
              <div className="timer-container">
                ...
                />
                <h1 className="timer">{timeLimit} Sec</h1>
              </div>
            </div>
          </div>
        </nav>
        <div className="game-page">
          {isGameInProgress && (
            <div className="game-container">
              <img src={activeImageUrl} alt="match" className="diaplay-image" />
              <ul className="tabs-container">
                {tabsList.map(eachTab => (
                  <TabItem
                    ...
                    onChangeTabItam={this.onChangeTabItam}
                  />
                ))}
              </ul>
              <div className="thumbnail-container">
                {filteredImages.map(eachImageItem => (
                  <ThumbnailItem
          ...
          {!isGameInProgress && this.renderWinOrLoseCard()}
        </div>
      </div>
    )
  }
